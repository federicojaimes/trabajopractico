		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#Exaccstrabajopractico-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Exaccstrabajopractico-display": {
								"semanticObject": "Exaccstrabajopractico",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Exaccs.trabajopractico",
									"url": sap.ui.require.toUrl("Exaccs/trabajopractico")
								}
							}
						}
					}
